...
safe = {
    ...
    "bootstrap_profile_mode": data.get("bootstrap_profile_mode"),
    "session_promoted": data.get("session_promoted") is True,
    "login_page_evidence": data.get("login_page_evidence"),
