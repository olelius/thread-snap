...
- 2026-08-08：PoC 功能样本仍缺目标圈子 URL，以及可见状态、正文、登录要求和确认时间的人工期望；证据见 `docs/research/poc-input-intake-2026-08-08.md` 第 6 节。
...
**下一步**：补齐顶部待裁决输入；随后从 2694 条输入池固定每轮 2000 条清单、随机种子和哈希，并启动候选 A/B 的功能冒烟。
