...
- [x] 从源码提交 `68af73f15836d36bbf47b9b8333f4d80821f462e` 构建 `threadsnap-poc-dual-runner-0.2.20-linux.tar.gz`，SHA-256为 `ebc34a439a8ac06018fba832e48f78c60aa9da206578e8e8cb9f6810753f07e1`；37/37项内部校验、Python `compileall` 和敏感运行文件排除通过。另生成仅覆盖解析器与README的 `threadsnap-content-semantics-hotfix-0.2.20.tar.gz`，SHA-256为 `3ba87a3ec0ba660d5c24da3af5cf7d768850ef8a54c512c25f5d999a213db57c`；在0.2.19完整包上覆盖验证确认3/3项内部校验、源码一致、Python编译通过，且模拟 `.runtime`、配置、输入和Session 4/4保持不变。
