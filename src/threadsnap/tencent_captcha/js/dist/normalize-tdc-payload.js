...
var preludeAst = t.cloneNode(ast, true);
var removedIndex = -1;
...
var prelude = generate(preludeAst, { compact: true, comments: false }).code;
vm.runInNewContext(prelude, sandbox, { timeout: 5e3, filename: "tdc-normalize-prelude.js" });
...
if (!payloadPath || payloadPath.node.value.length < 1e4) throw new Error("resolved VM payload not found");
...
var normalized = generate(ast, { comments: false, compact: false }).code + "\n";
