...
const recurringRunsRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/recurring-runs',
  component: lazyRouteComponent(() => import('@/features/runs/runs-page'), 'RecurringRunsPage'),
  validateSearch: validateRunsSearch,
})
...
const recurringRunDetailRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: '/recurring-runs/$runId',
  component: lazyRouteComponent(() => import('@/features/runs/run-detail-page'), 'RecurringRunDetailPage'),
  validateSearch: validateRunDetailSearch,
})
...
const routeTree = rootRoute.addChildren([indexRoute, runsRoute, recurringRunsRoute, runDetailRoute, recurringRunDetailRoute, configRoute, reputationRoute, reputationDetailRoute])
...
function validateRunsSearch(search: Record<string, unknown>) {
  return {
    page: optionalPositiveInteger(search.page),
...
function validateRunDetailSearch(search: Record<string, unknown>) {
  return {
