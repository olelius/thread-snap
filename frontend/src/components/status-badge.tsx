...
const tones: Record<string, string> = {
  ...
  starting: 'border-cyan-500/25 bg-cyan-500/10 text-cyan-700 dark:text-cyan-300',
  loading: 'border-cyan-500/25 bg-cyan-500/10 text-cyan-700 dark:text-cyan-300',
  ready: 'border-emerald-500/25 bg-emerald-500/10 text-emerald-700 dark:text-emerald-300',
  validating: 'border-indigo-500/25 bg-indigo-500/10 text-indigo-700 dark:text-indigo-300',
