...
function TemplatePanel() {
  ...
  const fields = useQuery({ queryKey: ['template-fields', selected?.platform_code, selected?.id], queryFn: () => api<TemplateField[]>(`/template-fields${queryString({ platform_code: selected?.platform_code, source_id: selected?.id })}`), enabled: Boolean(selected) })
